            ...
            <div className="space-y-12">
              ...
              <div className="w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                  ...
                  <FadeIn delay={0.3}>
                    <div className="glass-card rounded-2xl p-6 bg-gradient-to-br from-purple-50 to-violet-100 dark:from-purple-900/20 dark:to-violet-900/20 border border-gray-200 dark:border-white/20 shadow-md dark:shadow-xl shadow-gray-200/50 dark:shadow-white/5 h-full min-h-[280px] flex flex-col">
                      <h4 className="text-xl md:text-2xl font-semibold text-green-600 dark:text-green-400 mb-4 text-center">
                        One platform from first call to wire transfer
                      </h4>
                      <div className="flex-1 flex flex-col justify-center">
                        <ul className="list-disc list-outside space-y-3 pl-6 text-black dark:text-white">
                  ...
                  <FadeIn delay={0.35}>
                    <div className="glass-card rounded-2xl p-6 bg-gradient-to-br from-cyan-50 to-blue-100 dark:from-cyan-900/20 dark:to-blue-900/20 border border-gray-200 dark:border-white/20 shadow-md dark:shadow-xl shadow-gray-200/50 dark:shadow-white/5 h-full min-h-[280px] flex flex-col">
                      <h4 className="text-xl md:text-2xl font-semibold text-green-600 dark:text-green-400 mb-4 text-center">
                        30-second OMs with live updates
                      </h4>
                      <div className="flex-1 flex flex-col justify-center">
                  ...
                  <FadeIn delay={0.4}>
                    <div className="glass-card rounded-2xl p-6 bg-gradient-to-br from-orange-50 to-amber-100 dark:from-orange-900/20 dark:to-amber-900/20 border border-gray-200 dark:border-white/20 shadow-md dark:shadow-xl shadow-gray-200/50 dark:shadow-white/5 h-full min-h-[280px] flex flex-col">
                      <h4 className="text-xl md:text-2xl font-semibold text-green-600 dark:text-green-400 mb-4 text-center">
                        AI predicts perfect matches
                      </h4>
                      <div className="flex-1 flex flex-col justify-center">
                  ...
                  <FadeIn delay={0.45}>
                    <div className="glass-card rounded-2xl p-6 bg-gradient-to-br from-rose-50 to-pink-100 dark:from-rose-900/20 dark:to-pink-900/20 border border-gray-200 dark:border-white/20 shadow-md dark:shadow-xl shadow-gray-200/50 dark:shadow-white/5 h-full min-h-[280px] flex flex-col">
                      <h4 className="text-xl md:text-2xl font-semibold text-green-600 dark:text-green-400 mb-4 text-center">
                        Customer Life Time Value
                      </h4>
                      <div className="flex-1 flex flex-col justify-center">
                        <ul className="list-disc list-outside space-y-3 pl-6 text-black dark:text-white">
                          <li><b>Customer lock-in:</b> Borrower profiles, documents, and lender relationships live on-platform. Integrated workflows and historical data create high switching costs and increasing value over time.</li>
                          <li><b>Takeout financing:</b> Seamlessly transition from bridge/construction to permanent loans. Reuse data and documents, auto-generate packages, and leverage our lender network for the next phase.</li>
                          <li><b>Refinancing — RefiRadar:</b> Always-on, AI-powered monitoring that tracks rates, maturities, covenants, and market signals. Alerts borrowers at the perfect time to refinance for the best available terms, then launches the process in one click.</li>
                        </ul>
                      </div>
                    </div>
                  </FadeIn>
