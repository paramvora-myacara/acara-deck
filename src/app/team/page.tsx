      ...
      <main className="flex flex-col items-center min-h-screen p-4 md:p-8">
        ...
        <div className="w-full max-w-7xl mx-auto flex-grow my-12 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {teamMembers.map((member, idx) => (
              <div
                key={idx}
                className={`glass-card rounded-3xl p-8 bg-gradient-to-br ${member.gradient} border border-gray-200 dark:border-white/20 shadow-md dark:shadow-xl shadow-gray-200/50 dark:shadow-white/5 animate-fadeIn flex flex-col justify-center`}
